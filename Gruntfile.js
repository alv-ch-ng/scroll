    ...
    module.exports = function (grunt) {
        ...
        grunt.initConfig({
            ...
            uglify: {
                ...
                prod: {
                    files: {
                        'dist/alv-ch-ng.scroll.min.js': ['dist/alv-ch-ng.scroll.js']
                    }
                },
                example: {
                  options: {
            ...
            less: {
                prod: {
                    ...
                    files: {
                        'dist/css/scroll.css': ['src/less/scroll.less']
                    }
                },
                example: {
                  options: {
                  ...
                  files: {
                    'src/example/styles/scroll.css': ['src/less/scroll.less']
                  }
                }
            },
            copy: {
            ...
            cssbeautifier: {
                ...
                prod: {
                    files: {
                        'dist/css/scroll.css': ['dist/css/scroll.css']
                    }
                }
            },
            cssmin: {
                ...
                prod: {
                    files: {
                        'dist/css/scroll.min.css': ['dist/css/scroll.css']
                    }
                }
            },
            compress: {
                main: {
                    ...
                    files: [
                        { src: ['dist/css/scroll.min.css'], dest: 'dist/css/scroll.min.css' }
                    ]
                }
            },
            concat: {
              ...
              prod: {
                src: 'src/js/scroll.js',
                dest: 'dist/alv-ch-ng.scroll.js'
              }
            },
            jasmine: {
                unit: {
